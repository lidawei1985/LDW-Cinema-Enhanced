# LDW Cinema Enhanced v1

**光幕影院增强版 v1** — 在原版基础上修复海报加载慢/不显示、直播源卡死/不可用两大核心问题，并增加**更新清单数字签名**、**国内多镜像容灾**、**海报缓存加速**和**自动化验证工具**。

> 本仓库是 [lidawei1985/LDW-Cinema](https://github.com/lidawei1985/LDW-Cinema) 的增强分支（v1），用于对比验证改进效果。原仓库继续作为生产仓库使用。
